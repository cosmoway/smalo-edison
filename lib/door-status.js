...
function DoorStatus() {
  ...
  setInterval(function(){
    ...
    console.info({switch01: switch01_value, switch02: switch02_value, status:self._status});

    if (switch01_value === 1 && switch02_value === 0) {
      if (self.isUnlocked() === false) {
        console.info('changed the status of the door to unlock.');
      ...
      if (self.isLocked() === false) {
        console.info('changed the status of the door to lock.');
      ...
      if (self.isLocked() === true || self.isUnlocked() === true) {
        console.info('changed the status of the door to unknown.');
